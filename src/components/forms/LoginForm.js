          ...
          <div className="form-group row">
            ...
            <div className="col-10">
              <div className="input-group">
                ...
                <Text id="username" field="username" name="username" validate={Validator.email} required="required" className="form-control here" />
              </div>
            </div>
          </div>
          <div className="row">
          ...
          <div className="form-group row">
            ...
            <div className="col-10">
              <div className="input-group">
                ...
                <Text id="password" field="password" name="password" validate={Validator.password} type="password" required="required" className="form-control here" />
              </div>
            </div>
          </div>
          <div className="row">
